...
import { getHistoryLender } from "../../apis/ApiFunding";
    ...
    return (
        <>
            ...
            <div className="space-y-2 mt-4">
                {history.map((history, i) => (<div key={i} onClick={() => { setDetailId(history.loanId) }} className={"border overflow-hidden border-gray-800 justify-stretch items-stretch bg-sky-100 dark:bg-gray-700 h-24 base-shadow flex gap-2"}>
