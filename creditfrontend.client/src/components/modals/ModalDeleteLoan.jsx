...
import { deleteLoan, getHistoryBorrower } from "../../apis/ApiLoan";

const ModalDeleteLoan = ({ id, closeCallback }) => {
        ...
        <div>
            ...
            <div className="fixed top-1/2 overflow-hidden left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-gray-700 dark:border-gray-600 rounded-lg z-[1101]">
                <div className="px-3 border-b py-2">
                    <h1 className="text-2xl grow font-semibold pe-3">Hapus Loan?</h1>
                </div>
                <p className="text-center text-sm p-3 mb-5">
                    Loan yang dihapus tidak dapat dikembalikan lagi.
                </p>
...
export default ModalDeleteLoan;
